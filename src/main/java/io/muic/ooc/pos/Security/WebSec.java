...
//        http://stackoverflow.com/questions/19500332/spring-security-and-json-authentication
        ...
        http
                .authorizeRequests()
                .antMatchers("/login", "/logout","/user/register","/test/image/**","/test/del_menu","/demo/status_table", "/demo/check_login", "/test/each_kitchen", "/demo/show_cashier", "/each_table", "/demo/get_table_3","/each_kitchen").permitAll()
